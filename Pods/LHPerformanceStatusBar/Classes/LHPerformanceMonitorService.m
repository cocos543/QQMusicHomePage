...
- (instancetype)init{
    if (self = [super init]) {
        ...
        _fpsStatusBar = [[LHPerformanceStatusBar alloc] initWithFrame:CGRectMake(0, 44, [UIScreen mainScreen].bounds.size.width, 20.0)];
        //Notification
        ...
        [[NSNotificationCenter defaultCenter] addObserver: self
                                                 selector: @selector(applicationWillResignActiveNotification)
                                                   ...
                                                   object: nil];
        self.statusBarWindow = UIApplication.sharedApplication.windows[0];
